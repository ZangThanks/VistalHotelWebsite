        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li class="${param.active == 'rooms' || param.active == 'bookings' ? 'active' : ''}">
                        <a href="${pageContext.request.contextPath}/views/information/BookingHistory.jsp"><i class="fas fa-bed"></i> Room Management</a>
                    </li>
                    ...
                    <li class="${param.active == 'services' || param.active == 'loyalty' ? 'active' : ''}">
                        <a href="${pageContext.request.contextPath}/views/information/LoyaltyProgram.jsp"><i class="fas fa-concierge-bell"></i> Services</a>
                    </li>
                    <li class="${param.active == 'reports' ? 'active' : ''}">
                        <a href="${pageContext.request.contextPath}/views/information/IncidentReporting.jsp"><i class="fas fa-chart-line"></i> Reports</a>
                    </li>
            ...
            <div class="sidebar-footer">
                <p>&copy;
                    <%= java.time.Year.now() %> Vista Hotel</p>
            </div>
        </aside>