            ...
            <form action="${pageContext.request.contextPath}/login" method="post" id="loginForm">
                ...
                <div class="relative mb-6">
                    ...
                    <input type="text"
                           ...
                           id="email"
                           placeholder=" "
                           class="input-field w-full bg-transparent border-0 border-b border-white/20 pl-6 py-2 text-white text-sm outline-none focus:border-gold focus:ring-0 transition-all duration-300">
                    <label for="email"
                ...
                <div class="relative mb-6">
                    ...
                    <input type="password"
                           ...
                           id="password"
                           placeholder=" "
                           class="input-field w-full bg-transparent border-0 border-b border-white/20 pl-6 pr-8 py-2 text-white text-sm outline-none focus:border-gold focus:ring-0 transition-all duration-300">
                    <label for="password"
                           class="floating-label absolute left-6 top-2 text-gray-400 text-sm transition-all duration-300 pointer-events-none">
                        Mật khẩu
                    </label>
                    ...
                    <div class="mt-2 text-right">
                        <a href="forgot-password"
                           class="text-sm text-gold hover:underline">Quên mật khẩu?</a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <a href="${pageContext.request.contextPath}/google-login"
                       class="py-3 rounded-xl bg-white/5 border border-white/10 text-white text-sm font-medium flex items-center justify-center gap-2 hover:bg-white/10 transition-all duration-300">
                        <img src="${pageContext.request.contextPath}/assets/images/google.svg" class="w-5 h-5" alt="Google">
                        Google
                    </a>
                ...
                <div class="text-center mt-6 pt-6 border-t border-gray-600">
                    <p class="text-gray-400 text-sm">
                        ...
                        <a href="register" class="text-gold font-medium hover:underline">Đăng ký</a>
                    </p>
                </div>
            </form>
        </div>
